...
The following diagram provides a high-level overview of the complete pipeline for
**age and sex estimation from 3D dental STL files**. It highlights the clear
separation between the **training phase**, where age and sex labels are available,
and the **inference phase**, where only unlabeled STL geometry is provided.

![Workflow Diagram – Age & Sex Estimation from 3D Dental Casts](diagrams/workflow.png)

*Figure: End-to-end workflow showing STL-based feature extraction, supervised model
training using age and sex labels, and prediction of age and sex from new unlabeled
dental casts.*
